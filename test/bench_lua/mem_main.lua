-- run_bench.js memory-scaling driver (stock Lua side). Mirrors
-- test/service/bench_mem_main.js: launches N idle echo services on a dedicated
...
skynet.start(function()
    ...
    local handles = {}
    for _ = 1, n do handles[#handles + 1] = skynet.newservice("test/bench_lua/echo") end
