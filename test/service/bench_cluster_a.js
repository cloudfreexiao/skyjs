// run_bench.js phase-2 driver, node A (port 2528): caller + echo + orchestrator.
...
// test/bench_lua/cluster_main_a.lua.
skynet.register("main");
skynet.newservice("skyclusterd");
cluster.init();
cluster.register("main");
cluster.set_nodes({ b: "127.0.0.1:2529" });
cluster.open(2528);
