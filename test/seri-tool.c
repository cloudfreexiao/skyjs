/*
 * test/seri-tool.c -- reference packer/dumper for Task 5 acceptance.
 ...
 * a Lua node produces.
 *
 *   test/seri-tool gen  <file>   write a fixed scalar + array-table sequence
 *   test/seri-tool dump <file>   unpack and print the value sequence
 */
...
main(int argc, char *argv[]) {
	...
	if (strcmp(argv[1], "gen") == 0) {
		// sequence must stay in sync with test/service/seri-main.js
		lua_pushnil(L);
		lua_pushboolean(L, 1);
		lua_pushboolean(L, 0);
		lua_pushinteger(L, 0);
